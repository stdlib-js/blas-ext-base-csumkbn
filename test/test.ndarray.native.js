...
var csumkbn = tryRequire( resolve( __dirname, './../lib/ndarray.native.js' ) );
var opts = {
...
tape( 'the function has an arity of 4', opts, function test( t ) {
	t.strictEqual( csumkbn.length, 4, 'returns expected value' );
	t.end();
});
